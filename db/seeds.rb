...
1.times do |i|
  # Furniture Category (id:2)
  Comment.create(message: "出品しました！", user_id: '1', item_id: "2001")
  Comment.create(message: "素敵な商品ですね", user_id: '2', item_id: "2001")
  Comment.create(message: "Looks good to me !", user_id: '3', item_id: "2001")
end
# < /Comment登録 >

# < Like登録 >
1.times do |i|
  Like.create(user_id: '1', item_id: "2001")
  Like.create(user_id: '2', item_id: "2001")
  Like.create(user_id: '3', item_id: "2001")
  Like.create(user_id: '4', item_id: "2001")
  Like.create(user_id: '5', item_id: "2001")
end
# < /Like登録 >