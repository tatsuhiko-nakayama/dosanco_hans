...
# 10.times do |i|
#   # Furniture Category (id:2)
#   Comment.create(message: "#{i+1}回目のコメントです。", user_id: '1', item_id: '100')
#   Comment.create(message: "全角の長文のテスト。" * 10, user_id: '2', item_id: '100')
#   Comment.create(message: "Half-width" * 10, user_id: '3', item_id: '100')
# end
# # < /Comment登録 >
